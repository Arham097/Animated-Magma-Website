...
function files(index){
      var data = `
          ./Pictures/bridges00004.png
          ./Pictures/bridges00007.png
...
function canvas3(){
  const canvas = document.querySelector("#pg11-right>canvas");
  const context = canvas.getContext("2d");
